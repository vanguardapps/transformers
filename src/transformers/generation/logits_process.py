...
class KNNLogitsProcessor(LogitsProcessor):
    ...
    def __init__(
        ...
        self.datastore.build_target_datastore(encoder_input_ids, encoder_last_hidden_state)
    ...
    def __call__(
        ...
        probs = self.interpolation_coeff * knn_probs + (1 - self.interpolation_coeff) * model_probs
